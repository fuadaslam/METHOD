        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-6 mb-8">
              <p className="text-lg leading-relaxed text-primary-black/80">
            ...
            <div className="border-l-4 border-accent-lime pl-6 mb-8">
              <div className="text-sm font-mono text-primary-black/60 mb-2">
                RESULTS
              </div>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <div className="text-4xl font-heading font-black text-accent-lime mb-1">
                    45
                  </div>
                  <div className="text-sm text-primary-black/60">
                    Pounds Lost
                  </div>
                </div>
                <div>
                  ...
                  <div className="text-sm text-primary-black/60">Months</div>
                </div>
              </div>
            </div>
            <motion.button
